...
namespace Image_Processing_Operation_Pool
{
    ...
    public partial class InterfaceForm : MetroForm//DevExpress.XtraEditors.XtraForm
    {
...
/*
            RootObject rootObject1 = (RootObject)lbScript.Items[3];

            string sss= rootObject1.GenerateObjectHashCode();
            RootObject rootObject2 = (RootObject)lbScript.Items[3];
            rootObject2.parameters[0].Current_Value = "0";
            sss = rootObject2.GenerateObjectHashCode();
  */
           ...
           MessageBox.Show("The image to start with is: " + startIm);


            string hashName = "";
            string scriptData = "tic \n im = imread('" + startIm + "');\n";
            ...
            scriptFile.Close();
            string strCmdMatlab = "/C matlab.exe -nodisplay -nosplash -nodesktop -r \"run('" + Path.GetFullPath(SCRIPT_PATH + "MyScript.m" + hashName) + "');;\"";
